...
import src.C31_FisiereBinare_Serializare.Ex1.Constants;
import src.C31_FisiereBinare_Serializare.Ex1.GuestsList;
...
public class CarRentalSystem implements Serializable {
    ...
    protected boolean isCarRent(String plateNo) {
        return rentedCars.containsKey(plateNo);
    }

    // get the value associated to a key
    protected String getCarRent(String plateNo) {
        //3
    ...
    protected void rentCar(String plateNo, String ownerName) {
    ...
    protected void returnCar(String plateNo) {
        if (isCarRent(plateNo)) {
    ...
    protected int getTotalRented() {
        return this.totalRented;
    }

    // get Cars rented by a specific owner
    protected void getCarsNo(String ownerName) {
        if (rentedCarsByPerson.containsKey(ownerName)) {
    ...
    protected void getCarsList(String owner) {
    ...
    protected static void printCommandsList() {
